...
export async function generateMetadata({
	...
	return createMetadata({
		title: t("title"),
		description: `Cookie Policy for ${siteName}. Learn about how we use cookies and similar technologies on our website.`,
		openGraph: {
...
export default async function CookiePolicyPage({
	...
	const businessName =
		...
		"Website Starter";
	const businessEmail =
		process.env.NEXT_PUBLIC_BUSINESS_EMAIL || "privacy@example.com";

	const breadcrumbSchema = createBreadcrumbListSchema([
		{ name: t("common.home"), url: `${siteUrl}/${locale}` },
		{ name: t("cookies.breadcrumb"), url: `${siteUrl}/${locale}/cookies` },
	]);
						...
						<div className="mx-auto max-w-4xl">
							...
							<div className="prose prose-lg dark:prose-invert mt-8 max-w-none">
								<section className="mb-8">
									...
									<p>
										Cookies allow a website to recognize your device and store
										some information about your preferences or past actions.
										This helps improve your browsing experience and allows the
										website to provide you with more relevant content.
									</p>
								</section>
